...
export default function ChatRoom() {
    ...
    const onSend = async () => {
        ...
        if (!t || !cid) return
        setText('')
        await sendMessage({ cid, senderId: me.uid, text: t })
    ...
    return (
        ...
        >
            ...
            {/* Barre d'entrée : respecte la home bar iPhone / nav bar Android */}
...
const styles = StyleSheet.create({
    ...
    inputBar: {
        ...
        borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: 'rgba(255,255,255,0.2)', backgroundColor: BG
    },
    input: {
