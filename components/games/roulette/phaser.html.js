...
<div style="background: #0F5132; width: 100vw; height: 100vh; position: relative;">
    ...
    <div style="position:absolute;top:24px;left:24px;z-index:10;">
        <button id="btn-return"
            style="background:#FFD700;color:#222;border:none;border-radius:14px;padding:18px 38px;font-weight:bold;cursor:pointer;box-shadow:0 2px 8px #0006;font-size:2rem;">
            ᐸ </button>
    </div>
    <!-- Solde et mise en haut à droite -->
    <div
        style="position:absolute;top:24px;right:24px;z-index:10;display:flex;flex-direction:column;align-items:flex-end;">
        <div id="solde"
            style="background:#222a;color:#FFD700;padding:16px 32px;border-radius:14px;font-size:2rem;font-family:'Roboto Mono',monospace;margin-bottom:12px;box-shadow:0 2px 8px #0004;">
            Jetons : -- </div>
        <div id="mise"
            style="background:#222a;color:#FFD700;padding:16px 32px;border-radius:14px;font-size:1.6rem;font-family:'Roboto Mono',monospace;box-shadow:0 2px 8px #0004;">
            Mise : 0 </div>
    </div>
    <div
        style="width: 98vw; max-width: 740px; min-width: 320px; height: 900px; position: absolute; top: 180px; left: 50%; transform: translateX(-50%); display: flex; flex-direction: column; justify-content: flex-start; align-items: center;">
        ...
        <div style="margin-top:80px;display:flex;justify-content:center;gap:32px;">
            <button id="btn-spin"
                style="background:#FFD700;color:#222;font-weight:bold;border:none;border-radius:14px;padding:18px 38px;font-size:1.6rem;box-shadow:0 2px 8px #0006;cursor:pointer;">Spin</button>
            <button id="btn-clear"
                style="background:#eee;color:#222;font-weight:bold;border:none;border-radius:14px;padding:18px 38px;font-size:1.6rem;box-shadow:0 2px 8px rgba(201, 186, 186, 0.8);cursor:pointer;">Clear</button>
        </div>
    </div>
    <script>
        // --- LOGIQUE DU JEU ---
